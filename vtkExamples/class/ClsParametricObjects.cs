...
{
    class ClsParametricObjects
    {
        public static void ParametricObjects(RenderWindowControl renderWindowControl1)
        {
            ...
            // vtkParametricSpline parametricObject = vtkParametricSpline.New(); // Exception
        ...
        public static void ParametricObjectsDemo(RenderWindowControl renderWindowControl1)
        {
